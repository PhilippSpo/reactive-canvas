...
ReactiveCanvas.prototype.dblclick = function(e) {
	...
	if (this.insertMode === 'rect') {
		CanvasFunctions.insertRectangle(mouse, this.rectCollection, this.extendRectangle);
	}
	if (this.insertMode === 'poly') {
		insertedId = CanvasFunctions.insertPolygon(mouse, this.polyCollection, this.extendPolygon);
	}
	if(insertedId !== null) {
		this.createdId.set(insertedId);
