...
var dblclick = function(e) {
	...
	var mouse = CanvasFunctions.getMouseWithContextTranslation(e, self.translation, self.panZoomLayer.scaleFactor, self.canvas);
	var insertedId = null;
...
ReactiveCanvas.prototype.clear = function() {
	...
	ctx.clearRect(0, 0, canvas.width * this.panZoomLayer.scaleFactor, canvas.height * this.panZoomLayer.scaleFactor);
};
