...
Rectangle.prototype.drawHandles = function(ctx) {
  this.drawRectWithBorder(this.x, this.y, this.closeEnough, ctx);
  this.drawRectWithBorder(this.x + this.w, this.y, this.closeEnough, ctx);
  this.drawRectWithBorder(this.x + this.w, this.y + this.h, this.closeEnough, ctx);
  this.drawRectWithBorder(this.x, this.y + this.h, this.closeEnough, ctx);
};
