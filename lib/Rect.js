...
Rectangle.prototype.drawHandles = function(ctx) {
  ...
  c.drawRectWithBorder(this.x, this.y, this.closeEnough, ctx);
  c.drawRectWithBorder(this.x + this.w, this.y, this.closeEnough, ctx);
  c.drawRectWithBorder(this.x + this.w, this.y + this.h, this.closeEnough, ctx);
  c.drawRectWithBorder(this.x, this.y + this.h, this.closeEnough, ctx);
};
