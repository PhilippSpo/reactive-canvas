...
Polygon = function(id, polyCollection, canvasStateObj) {
  ...
  if (polygon.hasOwnProperty('textPos')) {
    this.textField.setPosition(polygon.textPos.x, polygon.textPos.y, this.canvasStateObj.canvas);
  }
...
Polygon.prototype.mousemove = function(e, mouse){
  if(this.dragging === true){
    ...
    this.translateCoordinate(e, mouse);
  }
...
Polygon.prototype.mouseup = function(e, mouse) {
  ...
  if (!this.selected) {
    ...
    if (this.textField.contains(mouse.x, mouse.y)) {
      this.textField.mouseup(e, mouse);
      return true;
    } else {
...
Polygon.prototype.translateCoordinate = function(e, mouse) {
