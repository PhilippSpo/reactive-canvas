...
TextField.prototype.initPosition = function (argument) {
	...
	if(shape.textPos){
		this.setPosition(shape.textPos.x, shape.textPos.y, this.canvasStateObj.canvas);
	}
};
...
TextField.prototype.mouseup = function(e, mouse) {
	this.selected = true;
	this.isTouched = false;
};

TextField.prototype.mousedown = function(e, mouse) {
	this.dragoff = {
		x: mouse.x - this.x,
		y: mouse.y - this.y
	};
...
TextField.prototype.mousemove = function(e, mouse) {
	if (this.dragging) {
...
TextField.prototype.deselect = function() {
	this.selected = false;
	this.dragging = false;
};
