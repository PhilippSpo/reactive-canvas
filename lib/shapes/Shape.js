...
Shape.prototype.isClippedShape = function() {
  if (this.canvasStateObj.clippedShape === this) {
    return true;
  }
  return false;
};
...
Shape.prototype.setOpacity = function(opacity) {
  ...
  if (typeof this.fixedOpacity !== 'undefined') {
    opacity = this.fixedOpacity;
  }
